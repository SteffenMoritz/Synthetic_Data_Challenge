...
# ACS GANe30
load("~/GitHub/Synthetic_Data_Challenge/results/sm_acs_gan_ctgan_epoch30.rda")
synd <- as.data.frame(h_dat_acs(result_gan_acs30))
...
save(list = c("results_acs_gane30"), file = paste0(getwd(), "/Evaluation_ACS_GANe30/results_acs_gane30_2.RData"))
