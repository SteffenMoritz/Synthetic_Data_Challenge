...
# ACS GANe10
load("~/GitHub/Synthetic_Data_Challenge/results/sm_acs_gan_ctgan_epoch10.rda")
synd <- as.data.frame(h_dat_acs(result_gan_acs))
...
save(list = c("results_acs_gane10"), file = paste0(getwd(), "/Evaluation_ACS_GANe10/results_acs_gane10_2.RData"))
