...
# ACS FCS
load("~/GitHub/Synthetic_Data_Challenge/results/rt_acs_fcs_samp100000.rda")
synd <- as.data.frame(h_dat_acs(ACS_synth_samp100000))
orig_acs <- h_dat_acs(as.data.frame(ACS_samp100000))
...
save(list = c("results_acs_FCS"), file = paste0(getwd(), "/Evaluation_ACS_FCS/results_acs_fcs2.RData"))
