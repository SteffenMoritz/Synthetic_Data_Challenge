...
# Define Algorithm
ctgan = CTGANSynthesizer(epochs=30)

# Fit - r.sat is the syntax to use variables from r scope 
ctgan.fit(r.acs, discrete_columns)

# Create samples from model
res = ctgan.sample(1035201)
...
result_gan_acs30 <- py$res
save(result_gan_acs30, file = "results/sm_acs_gan_ctgan_epoch30.rda")
```
