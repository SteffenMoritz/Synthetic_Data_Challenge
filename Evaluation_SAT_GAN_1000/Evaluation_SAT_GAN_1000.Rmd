...
#pp <- 
#  data.frame(`Replication Uniques.` = disclosure_own$replications_orig,  `Disclosure Count` = #disclosure_own$count_disclosure, `Disclosure Percentage` = disclosure_own$per_replications)
...
**The risk measures did not change significantly, thus higher epoch values were a clear benefit. (at the cost of computation time)**