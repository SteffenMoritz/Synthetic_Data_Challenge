...
# ACS IPSO 1
load("~/GitHub/Synthetic_Data_Challenge/results/fg_ipso_regsdc_conf_from_INCTOT.rda")
...
save(list = c("results_acs_IPSO1"), file = paste0(getwd(), "/Evaluation_ACS_IPSO_INCTOT/results_acs_IPSO1_2.RData"))
