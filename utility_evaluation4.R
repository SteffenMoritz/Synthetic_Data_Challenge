...
results_syn_sat_mnorm_simple <- list(
  ...
  cio = cio(syn_sat_mnorm_simple, orig_sat),
  ...
  ut = utility.tables(as.data.frame(syn_sat_mnorm_simple), as.data.frame(orig_sat), vars = names(orig_sat), max.scale = 10)
)  
...
results_syn_sat_mnorm_complex <- list(
  ...
  cio = cio(syn_sat_mnorm_complex, orig_sat),
  ...
  ut = utility.tables(as.data.frame(syn_sat_mnorm_complex), as.data.frame(orig_sat), vars = names(orig_sat), max.scale = 10)
)  
...
results_sm_ipso_regsdc_conf_hs_fy <- list(
  ...
  cio = cio(sm_ipso_regsdc_conf_hs_fy, orig_sat),
  ...
  ut = utility.tables(as.data.frame(sm_ipso_regsdc_conf_hs_fy), as.data.frame(orig_sat), vars = names(orig_sat), max.scale = 10)
)  
...
results_sm_sat_gan_ctgan_epoch1000 <- list(
  ...
  cio = cio(sm_sat_gan_ctgan_epoch1000, orig_sat),
  ...
  ut = utility.tables(as.data.frame(sm_sat_gan_ctgan_epoch1000), as.data.frame(orig_sat), vars = names(orig_sat), max.scale = 10)
)  
...
results_sm_sat_gan_ctgan <- list(
  ...
  cio = cio(sm_sat_gan_ctgan, orig_sat),
  ...
  ut = utility.tables(as.data.frame(sm_sat_gan_ctgan), as.data.frame(orig_sat), vars = names(orig_sat), max.scale = 10)
)  
...
results_sm_sat_fcs_cart <- list(
  ...
  cio = cio(sm_sat_fcs_cart, orig_sat),
  ...
  ut = utility.tables(as.data.frame(sm_sat_fcs_cart), as.data.frame(orig_sat), vars = names(orig_sat), max.scale = 10)
)  
